...
class RK_experiment:
    ...
    def process_and_detrend(self):
        ...
        #         saveloc='single_output_temp/pipeline_diag/signal_FT_sb.png',xlabel='Kinetic energy $E_f$ (eV)',ylabel='Indirect energy $\\hbar \\omega_\\tau$ (eV)', show=False,title='FT of the sideband signal')
